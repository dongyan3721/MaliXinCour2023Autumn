package com.example.genshinimpactcookbook.widget;
...
import com.example.genshinimpactcookbook.utils.BitmapUtil;
import com.example.genshinimpactcookbook.utils.CameraUtil;
import com.example.genshinimpactcookbook.utils.DateUtil;
import com.example.genshinimpactcookbook.utils.WaterMarkUtil;
...
public class CameraView extends SurfaceView {
    ...
    private PictureCallback mPictureCallback = new PictureCallback() {
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            // 获取本次拍摄的照片保存路径
            // TODO: add watermark
            bitmap = WaterMarkUtil.addPlainWatermark(bitmap, location);
            Log.d(TAG, "========: ========"+location);
